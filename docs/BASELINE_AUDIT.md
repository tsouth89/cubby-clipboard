...
Measure shortcut-to-visible latency, focus restoration, keyboard handling, Narrator output, high contrast, DPI and monitor placement, idle memory, and paste reliability. Keep Tauri only if it meets the native interaction contract without fragile workarounds.
